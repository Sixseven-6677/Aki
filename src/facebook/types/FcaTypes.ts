export interface FcaAttachment {
    ...
    /**
     * ws3-fca callback-based sendMessage.
     * Always pass a callback — omitting it causes "TypeError: callback is not a
     * function" as an unhandled rejection inside ws3-fca, crashing the process.
     */
    sendMessage(
     ...
     * Note: first arg is a boolean (isTyping), not threadID.
     */
    sendTypingIndicator(
      isTyping: boolean,
      threadID: string,
